...
echo "sudo pacman -S iwd nix ananicy-cpp clamav irqbalance cups pnpm mise mangohud distrobox docker gamescope tailscale" 
...
echo "sudo pacman -S iwd yay ananicy-cpp clamav irqbalance cups pnpm mise mangohud distrobox docker gamescope tailscale"     
cd ..
rm -rf jq
